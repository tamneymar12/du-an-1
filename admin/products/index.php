...
$products = queryExecute($getproductsQuery, true);
                    ...
                    <div class="row">
                        ...
                        <table class="table table-stripped">
                            <thead>
                                ...
                                <th>
                                    <a href="<?= ADMIN_URL . 'products/add-form.php' ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm</a>
                                </th>
                            </thead>
                            <tbody>
                                <?php foreach ($products as $pro) : ?>
                                    <tr>
                                        ...
                                        <td><img src="<?= BASE_URL . $pro['image'] ?>" width="100" alt=""></td>
                                        <td><?php if ($pro['status'] == 2) { ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo ADMIN_URL . 'products/edit-form.php?id=' . $pro['id'] ?>" class="btn btn-sm btn-info">
                                                <i class="fa fa-pencil-alt"></i>
                                            </a>

                                            <a href="<?php echo ADMIN_URL . 'products/remove.php?id=' . $pro['id'] ?>" class="btn-remove btn btn-sm btn-danger">
