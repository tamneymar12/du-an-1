...
$categories = queryExecute($getcategoriesQuery, true);
                    ...
                    <div class="row">
                        ...
                        <table class="table table-stripped">
                            <thead>
                               ...
                               <th>Nội dung</th>
                                <th>
                                    <a href="<?= ADMIN_URL . 'categories/add-form.php' ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm</a>
                                </th>
                            </thead>
                            <tbody>
