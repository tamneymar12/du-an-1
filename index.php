...
$getnewQuery = "select * from news limit 3";
...
<body class="ps-loading">
	...
	<main class="ps-main">
						...
						<div class="ps-product__column">
							<div class="ps-shoe mb-30">
								<div class="ps-shoe__thumbnail">
									<a class="ps-shoe__favorite" href="product-detail.php?idpro=<?= $pro['id'] ?>"><i class="ps-icon-heart"></i></a>
									<img src="<?= $pro['image'] ?>" alt=""><a class="ps-shoe__overlay" href="product-detail.php?idpro=<?= $pro['id'] ?>"></a>
								</div>
								<div class="ps-shoe__content">
									<div class="ps-shoe__detail">
										<a class="ps-shoe__name" href="product-detail.php?idpro=<?= $pro['id'] ?>">
											<?= $pro['name'] ?>
										</a>
		...
		<div class="ps-section--offer">
			<div class="ps-column"><a class="ps-offer" href="product-listing.html"><img alt="" src="<?= $web['banner'] ?>" /></a></div>

			<div class="ps-column"><a class="ps-offer" href="product-listing.html"><img alt="" src="<?= $web['image2'] ?>" /></a></div>
		</div>
		...
		<div class="ps-section ps-section--top-sales ps-owl-root pt-80 pb-80">
			<div class="ps-container">
				...
				<div class="ps-section__content">
					<div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-dots="false" data-owl-duration="1000" data-owl-gap="30" data-owl-item="4" data-owl-item-lg="4" data-owl-item-md="3" data-owl-item-sm="2" data-owl-item-xs="1" data-owl-loop="true" data-owl-mousedrag="on" data-owl-nav="false" data-owl-speed="5000" class="rounded float-left">
						<?php foreach ($products as $pro) : ?>
										...
										<div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detail.php?idpro=<?= $pro['id'] ?>"><?= $pro['name'] ?></a>
											...
											<p class="ps-shoe__categories"><a href="product-detail.php?idpro=<?= $pro['id'] ?>"> <?php if ($pro['status'] == 2) { ?>
													...
													<?php } else if ($pro['status'] > 2) { ?>
														<a class="text-success">Adidas</a>
													<?php } ?></a>,</a></p>
											<span class="ps-shoe__price"> $ <?= $pro['price'] ?></span>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="ps-section ps-home-blog pt-80 pb-80">
			<div class="ps-container">
				<div class="ps-section__header mb-50">
					...
					<div class="ps-section__action"><a class="ps-morelink text-uppercase" href="blog-detail.php">View all post</a></div>
				</div>
					...
					<div class="row">
						<?php foreach ($news as $new) : ?>
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
								...
								<div class="ps-post">
									<div class="ps-post__thumbnail"><img alt="" src="<?= $new['image'] ?>" /></div>

									<div class="ps-post__content"><a class="ps-post__title" href="blog-detail.php"><?= $new['name']?></a>

										<p class="ps-post__meta"><span>By:<a class="mr-5" href="blog.html">Alena Studio</a></span></p>

										<p><?= $new['content']?>&hellip;</p>
										<a class="ps-morelink" href="blog-detail.php?id=<?= $new['id']?>">Read more</a>
									</div>
								</div>
							</div>
						<?php endforeach; ?>
